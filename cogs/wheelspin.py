...
class wheelspin(commands.Cog):
    ...
    async def wheelspin(self, ctx: SlashContext):
        ans = [f"{ctx.author.mention} spinned the Lucky Wheel and got Sent to Kamurocho. \n You can spin the wheel again in 6h.",
               ...
               f"{ctx.author.mention} spinned the Lucky Wheel and got Mystery Spin + 10,000 XP <:CoolBread:839191670767616011> \n To use this, please ask an operator to spin the Mystery Spin. \n XP will be awarded within 6h. \n You can spin the wheel again in 6h.",
               f"{ctx.author.mention} spinned the Lucky Wheel and got Mystery Spin + 20,000 XP <:CoolBread:839191670767616011> \n To use this, please ask an operator to spin the Mystery Spin. \n XP will be awarded within 6h. \n You can spin the wheel again in 6h.",
               ]
